...
import { View, Text, TouchableOpacity, StyleSheet, Image, ActivityIndicator , Button} from "react-native";
...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Button
  title="Ir a test de deep link"
  onPress={() => navigation.navigate("TestDeepLink")}
/>
    </View>
  );
}
